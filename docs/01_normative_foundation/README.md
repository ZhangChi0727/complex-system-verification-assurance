...
- research task control: [Normative Research Task Register](research_tasks/README.md) 为每个仍有研究义务的标准或受控 work package 建立 agent-executable `version: 0.2` 任务说明，逐项控制来源、完整条款清单、证据提取、标准专属研究包、映射、仓库更新、评审包和完成条件；任务登记不表示 clause study 已开始；
