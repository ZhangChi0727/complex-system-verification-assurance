...
| Item | Finding |
|---|---|
| Source identity | PDF title/metadata and title page identify ISO/IEC/IEEE 29148:2018, second edition, 2018-11; the complete licensed local source has 104 pages |
| Independent source check | Title page, metadata, contents, Clauses 4, 5.2, 5.3, 5.4, 6.1, 6.5.2, 6.6, 7, 8, 9.5.18, 9.5.19, 9.6.19, and Annexes A-C checked |
| Source handling | Licensed local source; not committed; no internal locator retained in repository |
| Full conformance | Clause 4.2 combines 5.2.4-5.2.7, the three requirements-engineering processes identified in 6.1 for the applicable cited lifecycle-standard edition, Clause 7 information items, and required Clause 9/Annex A content |
...
Clauses 6.5 and 6.6 mix lifecycle-standard task text reproduced with its original modal force, ISO 29148 guidance/elaboration, and direct ISO 29148 `shall` statements. Those categories remain distinguishable in this study and the clause register. The conformance scope is determined by 4.2/6.1, not merely by a task being reproduced in 6.5 or 6.6. Adopting framework relations V2-V10 does not establish ISO 29148 process or full conformance.
...
| 5.2.3 | Direct-descriptive | Needs/goals/objectives are transformed into stakeholder requirements and recursively into lower-level requirements | `Need/Goal/Objective → Requirement` is directly present in source text, but is not an identity relation or an independent conformance claim |
...
The `Strength/source` column separates lifecycle-task wording reproduced from ISO/IEC/IEEE 15288:2015 or ISO/IEC/IEEE 12207:2017, ISO 29148 explanatory guidance, and direct ISO 29148 requirements. Original modal force is retained; none of these rows expands the 4.2/6.1 conformance claim scope.
...
| 6.5.2.2 | Referenced lifecycle-task requirement + ISO 29148 guidance/direct `shall` where stated | An appropriate method/technique and criteria are selected for each verification action; method definition can address how, responsibility, event timing and venue/environment | Preserve the task's original modal force and the direct `shall` statements; each framework obligation needs an addressed-by strategy/action relation and success criteria, but example responsibility fields are not universal mandatory fields |
...
| 6.5.2.3 | Referenced lifecycle-task requirement + ISO 29148 guidance/direct `shall` where stated | Maintain traceability of verified elements; associate methods and information with requirements and extend links through life-cycle work products | Preserve source modal force; strengthens requirement-to-method/result traceability and unique identity, while evidence provenance remains distinct from traceability |
...
Clause 6.6 likewise combines lifecycle-process task material, ISO 29148 elaboration/guidance and direct `shall` statements. The table records the resulting concepts without treating the entire clause as an additional full-conformance process set; organization/project process conformance continues to depend on 4.2/6.1 and the cited editions.
...
| DEP-29148-02 | DEPENDENCY OPEN | ISO/IEC/IEEE 15289:2019 source is acquired, but clause study and interoperability mapping have not started |
...
**Decision: ACCEPT AS REVIEWED NORMATIVE SOURCE FOR REQUIREMENTS ENGINEERING AND INFORMATION-ITEM CONTENT, WITH OPEN DEPENDENCIES.**

Independent review closed the required source-integrity, conformance-boundary and modal-strength clarifications. The study strengthens Requirement as a Verification Basis element and supports Requirement Set assessment plus BRS/StRS/SyRS/SRS views. The 15288:2015 to 15288:2023 process-version mapping remains open. Review does not freeze an executable model, close ISO-G07, or replace ISO 15288:2023.
