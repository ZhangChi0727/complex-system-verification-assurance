...
|---|---|---|---|---|---|---|---|---|
| A | ISO/IEC/IEEE 15288 | *Systems and software engineering — System life cycle processes* | Second edition, 2023-05 | ISO/IEC/IEEE | General systems life-cycle process context | Local licensed source — not committed | Reviewed; baseline candidate | See `standard_notes/iso_15288.md`; final classification awaits the initial cross-standard consistency review |
| A | ISO/IEC/IEEE 24748-1 | *Systems and software engineering — Life cycle management — Part 1: Guidelines for life cycle management* | Second edition, 2024-03 | ISO/IEC/IEEE | Life-cycle management, adaptation, process views, stages and gates | Clean official edition; local licensed source — not committed | Reviewed; baseline candidate | Authoritative research source form: clean official edition; see `standard_notes/iso_24748_1.md`; informative annex examples are not conformance requirements |
...
| B | SAE ARP4754B / EUROCAE ED-79B | *Guidelines for Development of Civil Aircraft and Systems* / paired EUROCAE document | ARP4754B, 2023-12; ED-79B details not independently studied | SAE / EUROCAE | Aircraft/system development assurance and aviation verification profile | Official SAE source available internally — not committed | Reviewed; baseline candidate | Recommended practice, not regulation; ARP4761A safety-analysis and DAL-assignment details remain deferred; see `standard_notes/sae_arp4754b.md` |
...
| C | SAE ARP4761A / EUROCAE ED-135 | *Guidelines for Conducting the Safety Assessment Process on Civil Aircraft, Systems, and Equipment* / paired EUROCAE document | ARP4761A, revised 2023-12; ED-135 not independently studied | SAE / EUROCAE | Civil-aircraft safety assessment, failure-condition analysis, assumptions, independence and FDAL/IDAL assignment | Official SAE source available internally — not committed | Reviewed; aviation-profile baseline candidate | Recommended practice, not regulation; Appendix Q is illustrative; see `standard_notes/sae_arp4761a.md` |
