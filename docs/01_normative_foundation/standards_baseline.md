...
本文件控制研究候选源、资料可得性、来源角色与研究状态。它冻结的是**变更流程**，不是标准全集：进入本表不表示条款已经研究，不得用未研究来源关闭 gap，也不表示 source-native schema、certification acceptance 或跨领域适用性已经建立。
...
| Domain assurance profile | Domain Profile；经抽象阶梯形成 generic 候选 | 直接把领域规则写成 universal rule |
| Instance standard | 实例 Verification Basis 与评价依据 | 充当 generic 方法论来源 |
| Execution technology | 原型实现与可替换技术选择 | 定义框架语义或信息模型 |

跨层流动只走 `../00_overview/research_scope.md` 的抽象阶梯；对象晋级登记于 five-source consolidation §28 annex。执行技术不属于 generic candidate-source 集合，其研究由原型需求触发。

## Change-control policy

1. Generic methodological source 的新增、替换或移除必须关联 open gap，记录候选角色、预期新信息、权威性、研究成本和 source-search 状态，并经 PR 评审；
2. Domain assurance profile 由明确领域适用性或实例需求触发；若提议泛化，另走抽象阶梯与 §28 登记；
3. Instance standard 由实例仓库需求触发，仅影响实例策略和评价映射；
4. Execution technology 由平台原型 ADR/选型研究控制，不用来关闭 normative gap；
5. 只有 `CLAUSE STUDY REVIEWED` 的来源可进入 `Established clause basis`。候选登记、`SOURCE ACQUIRED` 或 `METADATA VERIFIED` 均不足以关闭 gap；
6. 来源状态、版本和取代关系变化时必须同步本表、gap matrix、standards map、研究计划与 CHANGELOG。

## Controlled candidate-source register

`Availability` 只记录可审计的仓库状态，不提交受版权限制全文、内部 URL 或凭据。未由官方目录核验的字段统一写作 `metadata pending`。
...
| ISO/IEC/IEEE 15289:2019 | International Standard | *Content of life-cycle information items (documentation)* | Ed. 4 / 2019-07 | ISO/IEC/IEEE | Published; revision under development | 15289:2017 | Source acquired; not committed | Generic methodological source | ISO-G07 | SOURCE ACQUIRED; CLAUSE STUDY PENDING |
| ISO/IEC/IEEE 29148:2018 | International Standard | *Life cycle processes — Requirements engineering* | metadata pending | ISO/IEC/IEEE | metadata pending | metadata pending | Local licensed source; not committed | Generic methodological source | Verification Basis / requirement quality | SOURCE ACQUIRED; INTEGRATION PENDING |
| ISO/IEC/IEEE 15026-1:2025 | International Standard | *Systems and software assurance — Part 1: Vocabulary and concepts* | Ed. 2 / 2025-12 | ISO/IEC/IEEE | Published | 15026-1:2019 | Not acquired | Generic methodological source | assurance vocabulary / delta | METADATA VERIFIED; CLAUSE STUDY PENDING |
| ISO/IEC/IEEE 15026-1:2019 | International Standard | *Systems and software assurance — Part 1: Concepts and vocabulary* | Ed. 1 / 2019-03 | ISO/IEC/IEEE | Withdrawn | Replaced by 15026-1:2025; dated normative dependency of 15026-2:2022 | Not acquired | Generic methodological source | dependency and delta | METADATA VERIFIED; CLAUSE STUDY PENDING |
| ISO/IEC/IEEE 15026-2:2022 | International Standard | *Systems and software assurance — Part 2: Assurance case* | Ed. 2 / 2022-11 | ISO/IEC/IEEE | Published | ISO/IEC 15026-2:2011 | Local licensed source; not committed | Generic methodological source | Claim–Argument–Evidence / RQ4 | SOURCE ACQUIRED; INTEGRATION PENDING |
...
| ISO/IEC/IEEE 15026-4:2021 | International Standard | *Systems and software assurance — Part 4: Assurance in the life cycle* | Ed. 1 / 2021-05 | ISO/IEC/IEEE | Current published edition; DIS revision not a published replacement | ISO/IEC 15026-4:2012 | Not acquired | Generic methodological source | assurance lifecycle | METADATA VERIFIED; CLAUSE STUDY PENDING |
...
| ISO/IEC/IEEE 15939:2017 | International Standard | *Systems and software engineering — Measurement process* | Ed. 1 / 2017-05 | ISO/IEC/IEEE | Published; confirmed 2022 | ISO/IEC 15939:2007 | Not acquired | Generic methodological source | evidence metrics / criteria | METADATA VERIFIED; CLAUSE STUDY PENDING |
...
| SAE ARP4754B:2023 | Recommended Practice | *Guidelines for Development of Civil Aircraft and Systems* | Rev. B / 2023-12 | SAE | Published | ARP4754A | Local licensed source; not committed | Domain assurance profile | v0.2 aviation profile | CLAUSE STUDY REVIEWED |
| SAE ARP4761A:2023 | Recommended Practice | *Guidelines for Conducting the Safety Assessment Process on Civil Aircraft, Systems, and Equipment* | Rev. A / 2023-12 | SAE | Published | ARP4761 | Local licensed source; not committed | Domain assurance profile | v0.2 aviation profile | CLAUSE STUDY REVIEWED |
...
| ARINC 615A and applicable interface/environment standards | Instance standards | metadata pending by instance | metadata pending | applicable issuers | metadata pending | metadata pending | Not acquired | Instance standard | external instance scope | INSTANCE-CONTROLLED; METADATA PENDING |
