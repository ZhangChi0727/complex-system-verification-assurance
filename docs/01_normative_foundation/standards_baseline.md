...
| A | ISO/IEC/IEEE 15289 | Title/edition to be verified before study | TBD | ISO/IEC/IEEE | Content of life-cycle information items; executable-schema/interoperability dependency | Full text not available in repository | **Next priority; dependency open** | 29148/15026-2 study resolves conceptual item/view taxonomy only; clause-level mapping remains prohibited until source study |
...
| A | ISO/IEC/IEEE 29148 | *Systems and software engineering — Life cycle processes — Requirements engineering* | Second edition, 2018-11 | ISO/IEC/IEEE | Requirements engineering, requirement characteristics, verification interface and requirement information-item content | Local licensed source — not committed | Reviewed; post-v0.2 normative source | Strengthens Requirement/Requirement Set and BRS/StRS/SyRS/SRS views; 15288:2015→2023 process mapping remains open |
| A | ISO/IEC/IEEE 15026-2 | *Systems and software engineering — Systems and software assurance — Part 2: Assurance case* | Second edition, 2022-10 | ISO/IEC/IEEE | Assurance-case structure, Evidence Item, Supported Claim, Argument, Inference and Context | Local licensed source — not committed | Reviewed with normative dependency open | Structure source only; does not define content quality, sufficiency threshold, notation or acceptance authority |
| A | ISO/IEC/IEEE 15026-1 | *Systems and software engineering — Systems and software assurance — Part 1: Concepts and vocabulary* | 2019 edition cited by ISO 15026-2 | ISO/IEC/IEEE | Normative assurance/claim/uncertainty vocabulary dependency | Full text not available in repository | Dependency open; not studied | Required before full 15026-series terminology baseline can be frozen |
