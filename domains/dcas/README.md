...
后续必须通过 source mapping 将这些内容重新分类为 Generic Methodology、Domain Rule、Concrete Example、Tooling 或 Organizational Practice。不得提交原始内部培训材料、proprietary system design、confidential interfaces 或未脱敏截图。
